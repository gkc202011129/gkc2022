...
bool GkcDGP::checkLimitSchedule(const std::vector<uint32_t> &defaultData, const std::vector<uint32_t> &checkData)
{
...
dev::eth::EVMSchedule GkcDGP::getGasSchedule(unsigned int blockHeight)
{
    clear();
...
uint64_t
GkcDGP::getUint64FromDGP(unsigned int blockHeight, const dev::Address &contract, std::vector<unsigned char> data)
{
    uint64_t value = 0;
...
uint32_t GkcDGP::getBlockSize(unsigned int blockHeight)
{
    clear();
...
uint64_t GkcDGP::getMinGasPrice(unsigned int blockHeight)
{
    clear();
...
uint64_t GkcDGP::getBlockGasLimit(unsigned int blockHeight)
{
    clear();
...
bool GkcDGP::initStorages(const dev::Address &addr, unsigned int blockHeight, std::vector<unsigned char> data)
{
    initStorageDGP(addr);
...
void GkcDGP::initStorageDGP(const dev::Address &addr)
{
    storageDGP = state->storage(addr);
}

void GkcDGP::initStorageTemplate(const dev::Address &addr)
{
...
void GkcDGP::initDataTemplate(const dev::Address &addr, std::vector<unsigned char> &data)
{
    dataTemplate = CallContract(addr, data)[0].execRes.output;
}

void GkcDGP::createParamsInstance()
{
...
dev::Address GkcDGP::getAddressForBlock(unsigned int blockHeight)
{
...
void GkcDGP::parseStorageScheduleContract(std::vector<uint32_t> &uint32Values)
{
...
void GkcDGP::parseDataScheduleContract(std::vector<uint32_t> &uint32Values)
{
...
void GkcDGP::parseStorageOneUint64(uint64_t &value)
{
...
void GkcDGP::parseDataOneUint64(uint64_t &value)
{
...
dev::eth::EVMSchedule GkcDGP::createEVMSchedule()
{
    dev::eth::EVMSchedule schedule = dev::eth::EIP158Schedule;
