...
////////////////////////////////////////////////////////////// // gkc
	void setGkcSchedule(EVMSchedule _gkcSchedule) const { gkcSchedule = _gkcSchedule; }

	EVMSchedule& getGkcSchedule() const { return gkcSchedule; }
...
private:
	...
	mutable EVMSchedule gkcSchedule; // gkc
