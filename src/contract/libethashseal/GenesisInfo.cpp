...
#include "genesis/gkcMainNetwork.cpp"
...
#include "genesis/test/gkcTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
    ...
    {
    //Client genesis
    case Network::gkcMainNetwork: return c_genesisInfoGkcMainNetwork;
    case Network::MainNetwork: return c_genesisInfoMainNetwork;
    case Network::Ropsten: return c_genesisInfoRopsten;

    //Test genesis
    case Network::gkcTestNetwork: return c_genesisInfoGkcTestNetwork;
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
    switch (_n)
    {
    case Network::gkcMainNetwork: return c_genesisStateRootGkcMainNetwork;
    case Network::gkcTestNetwork: return c_genesisStateRootGkcTestNetwork;
