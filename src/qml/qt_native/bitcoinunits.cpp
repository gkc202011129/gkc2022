...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(GKC);
    unitlist.append(mGKC);
    unitlist.append(uGKC);
    return unitlist;
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case GKC:
            return QString("tGKC");
        case mGKC:
            return QString("mtGKC");
        case uGKC:
            return QString::fromUtf8("μtGKC");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case GKC:
            return QString("GKC");
        case mGKC:
            return QString("Milli-GKC (1 / 1" THIN_SP_UTF8 "000)");
        case uGKC:
            return QString("Micro-GKC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case GKC:
            return QString("TestGKCs");
        case mGKC:
            return QString("Milli-TestGKC (1 / 1" THIN_SP_UTF8 "000)");
        case uGKC:
            return QString("Micro-TestGKC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
