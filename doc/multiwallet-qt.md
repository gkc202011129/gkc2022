...
In order to support loading of multiple wallets in gkc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is gkc.cpp.
...
Changes to gkc.cpp
----------------------
gkc.cpp is the entry point into gkc-qt, and as such, will require some minor modifications to provide hooks for
