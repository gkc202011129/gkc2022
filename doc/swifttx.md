...
This mechanism has been integrated into Bitcore-Node-GKC which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/GKC-Project/insight-api-gkc#web-socket-api](https://github.com/GKC-Project/insight-api-gkc#web-socket-api) 
* API: [https://github.com/GKC-Project/insight-api-gkc#swifttx-transactions](https://github.com/GKC-Project/insight-api-gkc#swifttx-transactions) 
...
By default, the GKC Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the GKC Core daemon:
