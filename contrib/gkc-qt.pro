...
RESOURCES += src/qt/gkc.qrc src/qt/gkc_locale.qrc

TRANSLATIONS += src/qt/locale/gkc_bg.ts \
                src/qt/locale/gkc_de.ts \
                src/qt/locale/gkc_en.ts \
                src/qt/locale/gkc_es.ts \
                src/qt/locale/gkc_fi.ts \
                src/qt/locale/gkc_fr.ts \
                src/qt/locale/gkc_it.ts \
                src/qt/locale/gkc_ja.ts \
                src/qt/locale/gkc_pl.ts \
                src/qt/locale/gkc_pt.ts \
                src/qt/locale/gkc_ru.ts \
                src/qt/locale/gkc_sk.ts \
                src/qt/locale/gkc_sv.ts \
                src/qt/locale/gkc_vi.ts \
                src/qt/locale/gkc_zh_CN.ts \
                src/qt/locale/gkc_zh_TW.ts
